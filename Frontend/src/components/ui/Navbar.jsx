...
const Navbar = () => {
  return (
    <nav className="border-b border-gray-200 bg-indigo-800 z-50 fixed top-0 w-full">
      <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between p-4">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8 mt-4 md:mt-0">
          <ul className="flex flex-col md:flex-row items-start md:items-center md:space-x-8 font-medium">
            <li>
              <Link to="/" className=" py-2 px-3 text-white hover:text-indigo-600">
                Home
              </Link>
            </li>
            <li>
              <Link to="/about" className="py-2 px-3 text-white hover:text-indigo-600">
                About
              </Link>
            </li>
            <li>
              <Link to="/problem" className="py-2 px-3 text-white hover:text-indigo-600">
                Problem List
              </Link>
            </li>
          </ul>
