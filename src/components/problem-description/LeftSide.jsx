  ...
  return (
    <div className="w-full border-r border-gray-200">
      <div className="border-b border-gray-200">
        {/* <div className="flex">
          {["Description", "Editorial", "Solutions", "Submissions", "Chat AI"].map((tab, idx) => (
            <button
              key={tab}
    ...
    data-[state=active]:bg-indigo-100 data-[state=active]:text-indigo-600 data-[state=active]:shadow-sm 
