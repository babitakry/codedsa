...
export const LeftSide = ({ activeTab, setActiveTab, problem }) => {
  ...
  return (
    <div className="w-full ">
      <Tabs defaultValue="description" className="w-full max-w-4xl mx-auto rounded-2xl shadow-md border border-gray-200">
        <TabsList className="grid grid-cols-5 gap-2 w-full h-14 bg-white p-2 shadow-sm">
          <TabsTrigger
            value="description"
